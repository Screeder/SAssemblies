    ...
    class EloDisplayer
    {
        ...
        void CalculatePositions(bool calcEnemy)
        {
            ...
            foreach (var hero in heroes)
            {
                ...
                {
                    //MainFrame.Sprite.X + 70 + 32 + 10, MainFrame.Sprite.Y + 0 + 32
        ...
        private void Game_OnGameUpdateAsyncTextsSummary(KeyValuePair<Obj_AI_Hero, ChampionEloDisplayer> heroPair, int index, bool enemy)
        {
            Obj_AI_Hero hero = heroPair.Key;
            ChampionEloDisplayer champ = heroPair.Value;
            if (champ.Header.FinishedLoading != true)
            {
                ...
                champ.Header.Text = new Render.Text(0, 0, text, 20, SharpDX.Color.Orange);
                champ.Header.Text.PositionUpdate = delegate
                {
                    return champ.Header.Position;
                };
                champ.Header.Text.VisibleCondition = sender =>
                {
                    return Misc.Miscs.GetActive() && EloDisplayerMisc.GetActive() && EloDisplayerMisc.GetMenuItem("SAssembliesMiscsEloDisplayerKey").GetValue<KeyBind>().Active
                        && champ.IsFinished();
                };
                champ.Header.Text.OutLined = true;
                champ.Header.Text.Add(4);
                champ.Header.FinishedLoading = true;
            }

            String text1 = "tHer0x";
            String text2 = "Unranked (<30)";
            String text3 = "0/0";
            String text4 = "9W/11L";
            String text5 = "6.5/6.3/10.8";
            String text6 = "21/0/9";
            String text7 = "Zed";
            String text8 = "";
            String text9 = "0";
            String text10 = "0W/2L";
            String text11 = "6.0/6.0/4.5";
            ...
            Render.Text Text = new Render.Text("", MainFrame.Sprite.X + 70 + 32 + 10, MainFrame.Sprite.Y + 110 + 32, 20, SharpDX.Color.Orange);
        ...
        class ChampionEloDisplayer
        {
            ...
            public TextInfo Header = new TextInfo();
