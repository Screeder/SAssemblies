    ...
    class Program
    {
        ...
        private void CreateMenu()
        {
            ...
            try
            {
                ...
                MinionLocationMisc.Menu = Menu2.AddMenu(ref menu, new LeagueSharp.SDK.Core.UI.IMenu.Menu("SAssembliesMiscsMinionLocation", Language.GetString("MISCS_MINIONLOCATION_MAIN")));
