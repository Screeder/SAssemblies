...
namespace SAssemblies
{
    ...
    class Program
    {
        ...
        {
            CreateMenu();
            Common.ShowNotification("SAltarTimer loaded!", Color.LawnGreen, 5000);
        ...
        private void CreateMenu()
        {
            ...
            try
            {
                ...
                Menu2.MenuItemSettings AltarTimer = new Menu2.MenuItemSettings(typeof(Altar));

                menu.Add(new LeagueSharp.SDK.Core.UI.Menu("SAssembliesTimersAltar", Language.GetString("TIMERS_ALTAR_MAIN")));
                AltarTimer.Menu = (LeagueSharp.SDK.Core.UI.Menu)menu["SAssembliesTimersAltar"];
                AltarTimer.Menu.Add(new MenuItem<MenuBool>("SAssembliesTimersAltarSpeech", Language.GetString("GLOBAL_VOICE")) { Value = new MenuBool() });
                AltarTimer.CreateActiveMenuItem("SAssembliesTimersAltarActive");

                MainMenu2.AltarTimer = AltarTimer;
            }
            catch (Exception)
            {
                throw;
