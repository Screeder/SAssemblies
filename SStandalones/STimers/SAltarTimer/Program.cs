    ...
    class Program
    {
        ...
        private void CreateMenu()
        {
            ...
            try
            {
                ...
                AltarTimer.Menu = Menu2.AddMenu(ref menu, new LeagueSharp.SDK.Core.UI.IMenu.Menu("SAssembliesTimersAltar", Language.GetString("TIMERS_ALTAR_MAIN")));
                Menu2.AddComponent(ref AltarTimer.Menu, new LeagueSharp.SDK.Core.UI.IMenu.Values.MenuBool("SAssembliesTimersAltarSpeech", Language.GetString("GLOBAL_VOICE")));
