...
namespace SAssemblies
{
    class MainMenu : Menu
    {
        ...
        public static MenuItemSettings AvoidTracker = new MenuItemSettings();
    ...
    class Program
    {
        ...
        {
            CreateMenu();
            Common.ShowNotification("SAvoidTracker loaded!", Color.LawnGreen, 5000);
        ...
        private void CreateMenu()
        {
            ...
            try
            {
                ...
                //mainMenu.UpdateDirEntry(ref MainMenu.AvoidTracker, Avoid.SetupMenu(MainMenu.Tracker.Menu));
