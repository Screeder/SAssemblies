...
namespace SAssemblies
{
    class MainMenu : Menu
    {
        ...
        public static MenuItemSettings CrowdControlTracker = new MenuItemSettings();
        ...
        public MainMenu()
        {
            ...
            {
                { CrowdControlTracker, () => new CrowdControl() },
            };
        }
    ...
    class Program
    {
        ...
        {
            CreateMenu();
            Common.ShowNotification("SCrowdControlTracker loaded!", Color.LawnGreen, 5000);
